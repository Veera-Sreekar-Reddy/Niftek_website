...
export const services: ServiceCard[] = [
  ...
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          Our development services encompass the full software development lifecycle, from initial concept to
          deployment and maintenance. We build scalable, robust applications that grow with your business.
        </p>
        <div>
        ...
        <p className="text-niftek-dark/90 leading-relaxed">
          We use modern technologies and agile methodologies to deliver high-quality software solutions on time and
          within budget. Our development team is experienced in various programming languages, frameworks, and
          platforms.
        </p>
      </div>
    ),
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          In today&apos;s digital landscape, cybersecurity is paramount. Our AI-powered security solutions provide
          comprehensive protection against evolving cyber threats, ensuring your business data and systems remain
          secure.
        </p>
        <div>
        ...
        <p className="text-niftek-dark/90 leading-relaxed">
          Our cybersecurity experts use advanced AI and machine learning technologies to detect, prevent, and respond to
          security threats in real-time. We help you build a robust security posture that protects against both known
  ...
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          Our consulting services help you navigate the complex world of technology and make strategic decisions that
          drive business growth. We provide expert guidance tailored to your industry and business objectives.
        </p>
        <div>
        ...
        <p className="text-niftek-dark/90 leading-relaxed">
          Our consultants bring years of industry experience and deep technical expertise to help you identify
          opportunities, mitigate risks, and achieve your technology goals. We work as an extension of your team to
  ...
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          Transform your data into actionable insights with our comprehensive data solutions. We help you collect,
          manage, analyze, and leverage your data to drive informed business decisions.
        </p>
        <div>
        ...
        <p className="text-niftek-dark/90 leading-relaxed">
          Our data solutions enable you to unlock the full potential of your data assets. We design and implement
          scalable data infrastructure that supports your current needs while preparing for future growth and
          innovation.
        </p>
      </div>
    ),
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          Seamlessly connect your systems, applications, and data sources with our integration services. We ensure that
          new technologies work harmoniously with your existing infrastructure.
        </p>
        <div>
        ...
        <p className="text-niftek-dark/90 leading-relaxed">
          Our integration experts ensure that all your systems communicate effectively, reducing manual work and
          improving operational efficiency. We design integration solutions that are scalable, maintainable, and secure.
        </p>
      </div>
    ),
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          Conversations regarding the cloud have evolved significantly - from being merely about cost optimization and
          improved agility and scale, to being about the cloud&apos;s role as a key enabler of transformation in
          today&apos;s enterprise.
        </p>
        <p className="text-niftek-dark/90 leading-relaxed">
          Customers are looking to the cloud to enable them to deliver business resilience, help transform into a
          leading digital enterprise and deliver consistent sustainable growth. Given this, the business world is
          witnessing a mad dash to the cloud. In this haste to stay competitive, enterprises find themselves at
          different stages of the cloud adoption journey, with some thriving and others still making sense of the
  ...
  },
  {
    ...
    content: () => (
      <div className="space-y-4">
        <p className="text-niftek-dark/90 leading-relaxed">
          Your data, no matter how big or small, has a story to tell. We all know that a picture is worth a thousand
          words. So why are you still flipping through pages of numbers? Business Intelligence will surface the right
          information to accelerate decision-making.
        </p>
        <p className="text-niftek-dark/90 leading-relaxed">
          Our intelligence solutions allow your organization data to tell its unique story. With truly accessible data,
          users can design and deploy their own reports and analyses based on one source of truth. Our expertise in
          Power BI and Tableau will help you deliver actionable enterprise-level insights across your organization.
        </p>
        <div>
